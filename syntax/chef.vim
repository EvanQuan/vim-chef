...
syntax match chefIngredientName /[a-zA-Z ]\+/ contained contains=chefMeasure,
      \ chefOperator,chefMixingBowl,chefBakingDish,chefTimeUnit
...
syntax keyword chefOperator from into to for until with contents of the contained
syntax match chefMethod /^\(Take\|Put\|Fold\|Add\|Remove\|Combine\|Divide\|Add\|Liquefy\|Liquify\|Mix\|Clean\|Pour\|Stir\|Set\|Serve\|Refrigerate\|Wait\) [0-9a-zA-Z ]\+.$/ contains=chefIngredientName,chefOperator,chefVerb,chefMixingBowl,chefBakingDish,chefNumber,chefTimeUnit
syntax match chefMixingBowl /mixing bowl/ contained
syntax match chefBakingDish /baking dish/ contained
...
syntax match chefPreheatOvenDefinition /^Pre-heat oven to [-]\?[0-9]\+ \(degree\|degrees\) Celsius.$/ contains=chefPreheatOvenLabel,chefOperator,chefNumber,chefTemperatureUnit
...
highlight link chefOperator Operator
